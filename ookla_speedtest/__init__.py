...
from .helpers import ensure_shell_scripts_executable, validate_server_id
...
async def async_setup_entry(hass: HomeAssistant, entry: ConfigEntry) -> bool:
    ...
    # Ensure shell scripts have execute permissions (handles git installations)
    await hass.async_add_executor_job(ensure_shell_scripts_executable)
